...
if (isset($_POST["submit"])) {
    ...
    try {
        ...
        $mail->Username   = 'ashishpal2203@gmail.com';        // SMTP username
        $mail->Password   = 'lfle uaui buva kmzs';            // SMTP password
        ...
        $mail->addAddress('ashishpal2204@gmail.com');                   // Add a recipient
