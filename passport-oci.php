...
<section id="travel-visas">
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseFive" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            ...
                            <p><b><u>Minor passport applications (below 18 years of age):</u></b>
                            </p>
                            <p>- Fresh Passport/Re-issue of Passport:
                            </p>
                            <ul>
                    ...
                    <div id="flush-collapseSix" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li><b>Document Submission:</b> After your application is prepared, simply submit the
                                    required
                                ...
                                <li><b>Passport Delivery:</b> Once approved, your passport will be securely delivered to
                                    your
    ...
    <div class="container">
        <div class="d-flex align-items-center gap-2 travel-title-main custom-width">
            <div class="section-title mb-0" style="width: 41%;">
                <h2 class="mb-0"><span>OCI </span>SERVICES</h2>
                <!-- (Overseas Citizenship of India) -->
            </div>
            <p class="travel-title">OCI is a life-long permit in a form of a booklet to enter India without the need to
                apply for a visa each time you travel. Reach out to our dedicated team today to assess your eligibility
                and let OCI unlock the doors to your Indian heritage and beyond.</p>
        </div>
