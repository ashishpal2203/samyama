                        ...
                        <div class="service-card blue">
                            ...
                            <div class="card-body">
                                <p>Experience hassle-free Indian Passport and OCI
                                    application processes with Samyama. Benefit from
                                    a complimentary initial consultation and our
                                    comprehensive end-to-end solutions for seamless
                                    application filing.</p>
                                <a href="#">Learn more</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="main-time-line ">
                    <div class="row section-point">
                        <div class="col-lg-6">
                            <div class="simple-step-image">
                                <img src="assets/images/consultation.png" alt="" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row section-point">
                        ...
                        <div class="col-lg-6">
                            <div class="simple-step-image">
                                <img src="assets/images/procecing.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="row section-point">
                        <div class="col-lg-6">
                            <div class="simple-step-image">
                                <img src="assets/images/submission.png" alt="" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="simple-image-content">
                                ...
                                <h5>Submit your application pack at the appropriate authority or opt for our services to
                                    do
                                    it for you.</h5>
                                <p>After preparing your application pack, your application will be submitted as per the circumstances to the respective authorities: embassy, Passport Seva Kendra, FRRO or university. We will keep you updated regarding the progress.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row section-point">
                        <div class="col-lg-6">
                            <div class="simple-image-content">
                                ...
                                <p>Your processed documents will be delivered to your residence after approval by the authorities. If returned to our office, we will deliver it to you and confirm your schedule beforehand.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="simple-step-image">
                                <img src="assets/images/delivery.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <div class="row section-point">
                        <div class="col-lg-6">
                            <div class="simple-step-image">
                                <img src="assets/images/End -To-End-Solution.png" alt="" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="simple-image-content">
