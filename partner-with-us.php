                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="cunsult-form">
                            <h4 class="cunsult-form-title partner-form">You can also fill in this partnership form and
                            ...
                            <div class="cunsult-form-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control w-100" id="basic-url"
                                        ...
                                        placeholder="Enter company/university name">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control w-100" id="basic-url"
                                        aria-describedby="basic-addon3 basic-addon4" placeholder="Enter your message">
                                </div>
                                <div class="cunsult-form-footer">
                                    ...
                                    <div class="buttonBox">
                                        <button data-bs-toggle="modal" data-bs-target="#partnership-submit">Get Started</button>
                                    </div>
                                </div>
                            </div>
                        </div>
